...
<html>
<head>
  <title>IMMEDIACY — Post-Mortem Report</title>
  <style>
    @media print {
      @page {
        size: A4;
...
<body>
  <h1>IMMEDIACY — Every Second Counts</h1>
  ...
  <div class="summary">
    ...
    <div class="metric">
      <span class="metric-label">Measured Control Index:</span>
      <span class="metric-value">${(measuredIndex * 100).toFixed(1)}%</span>
    </div>
    <div class="metric">
      <span class="metric-label">Disclosure Debt Index:</span>
  ...
  <div class="footer">
    ...
    <p>This report represents a simulated disclosure war game and its impacts.</p>
  </div>
</body>
</html>
  `
